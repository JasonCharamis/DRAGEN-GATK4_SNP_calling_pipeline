...
- [DRAGMAP v1.3.0](https://github.com/Illumina/DRAGMAP)
...
- sample list(s): file containing sample prefixes (one per line); if individuals were sequenced across multiple lanes, create two separate prefix lists - one with and one without lane designations|                                                                Unmerged                                                                |                                      Merged                                      |
  | :-------------------------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------: |
...
### Job information outputs (found in $)
...
### DRAGMAP alignment statistics for each sample (found in $/03_AlignStats/*sampleID*)
...
### VCF statistics (found in $/04_GATKvcfs)
